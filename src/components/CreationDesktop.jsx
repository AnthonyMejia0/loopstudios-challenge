...
function CreationDesktop({ lineOne, lineTwo, img }) {
  const [opacity, setOpacity] = useState("bg-black opacity-20");

  return (
    <div
      id="wrapper"
      className="relative p-4 text-white hover:text-black cursor-pointer"
    ...
    >
      ...
      <div className="absolute z-20 flex flex-col text-3xl justify-center bottom-0 left-0 px-11 m-4 w-[85%] h-[8.5rem]">
